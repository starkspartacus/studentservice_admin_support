...
export const MOCK_PENDING_VALIDATIONS: PendingValidation[] = [
  ...
  },
  {
    ...
    avatar: 'https://utfs.io/f/k0pujIK1Hvzfw23ccZV0Q9IYWNpjJfnrTawgC2U3dKhZK0M',
    university: 'Université Félix Houphouët-Boigny (Abidjan - Cocody)',
    field: 'Informatique & Génie Logiciel',
    studentId: 'CI88-77-AA-ZZ',
    submittedAt: 'Il y a 1 heure',
    studentCardUrl: 'https://utfs.io/f/k0pujIK1HvzfwTiyANDPRtdkIB2crNm0w186s7XGVp3YnObK',
    selfieUrl: 'https://utfs.io/f/k0pujIK1HvzfK55sB5ZK1HvzfZJ8ECbwZciOMjVG5Du3Lhn9p',
    idCardRectoUrl: 'https://utfs.io/f/k0pujIK1HvzfHJQwXn9UwiEI0y8tDA3GZM2xepfPgmQhvbz',
    idCardVersoUrl: 'https://utfs.io/f/k0pujIK1HvzfbCiLcNqp8reP3ICvRX17oDB5EyTqclw2ijua',
    status: 'APPROVED',
  },
  {
    id: 'val-4',
